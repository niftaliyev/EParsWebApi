...
{
    public class VipEmlakAzSettlementNames
    {
        Dictionary<string, int> settlementNames = new Dictionary<string, int>();


        public VipEmlakAzSettlementNames()
        {
            ...
            settlementNames.Add("Sabunçu qəsəbəsi", 72);
            ...
            settlementNames.Add("Şərq qəsəbəsi", 93);
