...
namespace WebApi.Services.EvinAz
{
    public class EvinAzSettlementNames
    {
        ...
        public EvinAzSettlementNames()
        {
            ...
            settlementNames.Add("2-ci Alatava q.", 17);
            settlementNames.Add("28 May", 18);
            settlementNames.Add("6-cı mikrorayon q.", 19);
            settlementNames.Add("7-ci mikrorayon q.", 20);
            settlementNames.Add("8-ci mikrorayon q.", 21);
            settlementNames.Add("9-cu mikrorayon q.", 22);
            ...
            settlementNames.Add("M.Ə.Rəsulzadə q.", 27);
            ...
            settlementNames.Add("Bibi Heybət q.", 44);
            ...
            settlementNames.Add("1-ci mikrorayon q.", 55);
            settlementNames.Add("2-ci mikrorayon q.", 56);
            settlementNames.Add("3-ci mikrorayon q.", 57);
            settlementNames.Add("4-ci mikrorayon q.", 58);
            settlementNames.Add("5-ci mikrorayon q.", 59);
            settlementNames.Add("Kubinka q.", 60);
            settlementNames.Add("8-ci kilometr q.", 61);
            ...
            settlementNames.Add("20-ci sahə q.", 77);
