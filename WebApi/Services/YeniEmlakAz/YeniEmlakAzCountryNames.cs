...
namespace WebApi.Services.YeniEmlakAz
{
    public class YeniEmlakAzCountryNames
    {
        ...
        public YeniEmlakAzCountryNames()
        {
            ...
            countryNames.Add("Naxçıvan MR",47);
            ...
            countryNames.Add("Xaçmaz / Xudat",30);
